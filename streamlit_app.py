...
def parse_menu(json_data):
    ...
    - Includes only items from entrée categories
    - Excludes sides, milk, fruit, vegetables, condiments
    """
    EXCLUDED_CATEGORIES = {
